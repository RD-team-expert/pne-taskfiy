...
addDebouncedEventListener('#task_status_filter, #task_priority_filter, #task_user_filter, #task_client_filter, #task_project_filter', 'change', function (e, refreshTable) {
    e.preventDefault();
