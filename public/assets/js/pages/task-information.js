            ...
            <details open class="comment" id="comment-${data.comment.id}">
                ...
                : `${imageBaseUrl}/storage/photos/no-image.jpg`
                        ...
                        <div class="comment-info">
                            ${showProfileLink
                ? `<a href="${isClient ? `${imageBaseUrl}/clients/profile/${commenter.id}` : `${imageBaseUrl}/users/profile/${commenter.id}`}"
                        ...
                        <div class="attachment-item d-flex align-items-center gap-3">
                            ...
                            <div class="attachment-preview-container flex-grow-1">
                                <a href="${imageBaseUrl}/storage/${att.file_path}" target="_blank"
                                   ...
                                   data-preview-url="${imageBaseUrl}/storage/${att.file_path}">
                                    ${att.file_name ? att.file_name : 'Attachment'}
                                </a>
                            ...
                            <div class="attachment-actions d-flex gap-2">
                                ...
                                <a href="${imageBaseUrl}/storage/${att.file_path}"
                                   download="${att.file_name ? att.file_name : 'file'}"
                                ...
                                <a href="javascript:void(0);" class="text-danger delete-attachment"
                                   data-attachment-id="${att.id}" title="${label_delete}">
...
$(function () {
    ...
    $('#confirmDelete').on('click', function () {
        ...
        $.ajax({
            type: 'DELETE',
            url: baseUrl + '/projects/comments/destroy-attachment/' + attachmentId,
            dataType: 'JSON',
            headers: {
            ...
            complete: function () {
                $('#confirmDelete').attr('disabled', false).html(originalButtonText);
