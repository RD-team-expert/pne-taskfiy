                        ...
                        <div class="col-md-12">
                            ...
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                ...
                                <?php
                                            ...
                                            echo '<span class="badge badge-center rounded-pill bg-primary mx-1">+' . $remainingUsers . '</span>';
                                            break;
                                        }
                                    }
                                } else {
                        ...
                        <div class="col-md-12">
                            ...
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                ...
                                <?php
                                            ...
                                            echo '<span class="badge badge-center rounded-pill bg-primary mx-1">+' . $remainingClients . '</span>';
                                            break;
                                        }
                                    }
                                } else {
